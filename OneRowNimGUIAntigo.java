...
public class OneRowNimGUIAntigo extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        OneRowNimGUIAntigo frame = new OneRowNimGUIAntigo(); // Cria uma instância da classe OneRowNimGUI
